...
public class JTRightAuto2Spec extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            sleep(1000);
            tracker.moveTo(specimenPlaceX, specimenInitPlaceY, 0, 0.1, 0.5, 0.8);
            elbowClaw.setPosition(1);
            ...
            // HP: SAMP 2 --> SPEC 2
            tracker.moveTo(24, -36, -90, 1, 0.5, 0.8);

            // ROB: squares with back wall
            // HP: Aligns SPEC 1
            tracker.setMotorsMecanum(0, 0.6, 0);
            sleep(1300);
            tracker.stopMotors();
            ...
            // ROB: grabs SPEC 1
            tracker.moveToPose(specimenGrabPose, 0.1, 0.5, 0.5);
            elbowClaw.setPosition(1);
            sleep(500);
            ...
            // HP: aligns SPEC 2
            armPID.setTarget(JArm.specimenPlace);
            tracker.moveTo(specimenPlaceX-6, specimenInitPlaceY + specimenPlaceYOffset, 0, 1, 0.5, 1.0);
            tracker.moveTo(specimenPlaceX, specimenInitPlaceY + specimenPlaceYOffset, 0, 0.1, 0.5, 0.8);
